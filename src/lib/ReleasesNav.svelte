...
<TextBlock>
	<h2 class="u-text-center u-mb-xs">More releases</h2>
	<p class="u-subhead u-text-center u-mb-md">
		<a class="u-font-md" href="./">All releases</a>
	</p>
		...
		<ul class="releases-nav-list">
			{#if newerRelease}
				<li class="releases-nav-item">
					...
					<div class="releases-nav-caption">
						<div class="u-subhead u-font-sm u-mb-0">Newer:</div>
			...
			{#if !newerRelease}
				<li class="releases-nav-item">
					...
					/>
					<div class="releases-nav-caption">
						<div class="u-subhead u-font-sm u-mb-0">Oldest:</div>
						<div class="releases-nav-heading u-heading u-font-lg u-mb-0">
							{oldestRelease.title} by {oldestRelease.artist}
						</div>
					</div>
			...
			{#if olderRelease}
				<li class="releases-nav-item">
					...
					/>
					<div class="releases-nav-caption">
						<div class="u-subhead u-font-sm u-mb-0">Older:</div>
						<div class="releases-nav-heading u-heading u-font-lg u-mb-0">
							{olderRelease.title} by {olderRelease.artist}
						</div>
					</div>
			...
			{#if !olderRelease}
				<li class="releases-nav-item">
					...
					/>
					<div class="releases-nav-caption">
						<div class="u-subhead u-font-sm u-mb-0">Newest:</div>
						<div class="releases-nav-heading u-heading u-font-lg u-mb-0">
							{newestRelease.title} by {newestRelease.artist}
						</div>
					</div>
